/* @ds-bundle: {"format":3,"namespace":"KYNDesignSystem_c46135","components":[{"name":"Button","sourcePath":"components/buttons/Button.jsx"},{"name":"IconButton","sourcePath":"components/buttons/IconButton.jsx"},{"name":"Badge","sourcePath":"components/feedback/Badge.jsx"},{"name":"Checkbox","sourcePath":"components/forms/Checkbox.jsx"},{"name":"Input","sourcePath":"components/forms/Input.jsx"},{"name":"Card","sourcePath":"components/surfaces/Card.jsx"},{"name":"ProductCard","sourcePath":"components/surfaces/ProductCard.jsx"}],"sourceHashes":{"components/buttons/Button.jsx":"08d2e89931ee","components/buttons/IconButton.jsx":"ffa379193cc4","components/feedback/Badge.jsx":"e44f770d99b7","components/forms/Checkbox.jsx":"dbb246cfe261","components/forms/Input.jsx":"40bf90113d33","components/surfaces/Card.jsx":"c5089af025f0","components/surfaces/ProductCard.jsx":"315db980e4c9","deck-stage.js":"0cc26af2402a"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.KYNDesignSystem_c46135 = window.KYNDesignSystem_c46135 || {});
...
function Button({
  ...
  const Tag = as;
  const classes = ['kyn-btn', `kyn-btn--${variant}`, `kyn-btn--${size}`, disabled ? 'kyn-btn--disabled' : '', className].filter(Boolean).join(' ');
...
function IconButton({
  ...
  const classes = ['kyn-iconbtn', `kyn-iconbtn--${size}`, className].filter(Boolean).join(' ');
...
function Badge({
  tone = 'soft',
  // 'pop' | 'brand' | 'soft' | 'blush' | 'mint' | 'butter' | 'outline'
  icon = null,
  children,
  className = '',
  ...rest
...
function Checkbox({
  ...
  return /*#__PURE__*/React.createElement("label", {
    className: ['kyn-check', className].filter(Boolean).join(' ')
...
function Input({
  ...
  const inputClasses = ['kyn-input', error ? 'kyn-input--error' : '', className].filter(Boolean).join(' ');
  return /*#__PURE__*/React.createElement("div", {
    className: "kyn-field"
  }, label && /*#__PURE__*/React.createElement("label", {
    className: "kyn-field__label",
    htmlFor: inputId
  }, label), /*#__PURE__*/React.createElement("input", _extends({
    id: inputId,
    className: inputClasses,
    "aria-invalid": error || undefined
  }, rest)), error && errorText ? /*#__PURE__*/React.createElement("span", {
    className: "kyn-field__hint",
    style: {
      color: 'var(--danger)'
    }
...
function Card({
  ...
  const Tag = as;
  const classes = ['kyn-card', interactive ? 'kyn-card--interactive' : '', className].filter(Boolean).join(' ');
  return /*#__PURE__*/React.createElement(Tag, _extends({
    className: classes
  }, rest), children);
}
...
function ProductCard({
  ...
  price,
  badge = null,
  // e.g. <Badge tone="pop">New</Badge>
  favIcon = null,
  // icon for the favorite button (e.g. <Heart/>)
  media = null,
  // <img/> or placeholder node
  swatches = [],
  ...
  const classes = ['kyn-product', interactive ? 'kyn-product--interactive' : '', className].filter(Boolean).join(' ');
  return /*#__PURE__*/React.createElement("article", _extends({
    className: classes
  }, rest), /*#__PURE__*/React.createElement("div", {
    className: "kyn-product__media"
  }, media, badge, favIcon && /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "kyn-iconbtn kyn-iconbtn--sm kyn-product__fav",
    "aria-label": "Add to favorites",
    onClick: onFavorite
  }, favIcon)), /*#__PURE__*/React.createElement("div", {
    className: "kyn-product__body"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "kyn-product__name"
  }, name), description && /*#__PURE__*/React.createElement("p", {
    className: "kyn-product__desc"
  }, description), /*#__PURE__*/React.createElement("div", {
    className: "kyn-product__row"
  }, /*#__PURE__*/React.createElement("span", {
    className: "kyn-product__price"
  }, price), swatches.length > 0 && /*#__PURE__*/React.createElement("span", {
    className: "kyn-product__swatches"
  }, swatches.map((c, i) => /*#__PURE__*/React.createElement("i", {
    key: i,
    style: {
      background: c
    }
